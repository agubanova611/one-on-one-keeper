...
import { Calendar, Mail, Briefcase, Building, Edit, Plus, CheckSquare } from "lucide-react"
    ...
    <div className="space-y-6">
      <div className="flex items-start justify-between">
        ...
        <div className="flex gap-2">
          <Button asChild>
            <Link href={`/dashboard/meetings/new?employee=${id}`}>
        ...
        <CardHeader className="flex flex-row items-center justify-between">
          ...
          {meetings.length > 0 && (
            <Button variant="ghost" size="sm" asChild>
              <Link href={`/dashboard/meetings?employee=${id}`}>Все встречи</Link>
            </Button>
          )}
        </CardHeader>
        <CardContent>
